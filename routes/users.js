...
router.post('/login', passport.authenticate('local', {successRedirect:'/admin', failureRedirect:'/login',failureFlash: true, successFlash: true}), function(req, res) {
	//req.flash('error_msg', 'Du er nu logget ind uden administerende rettigheder');
	res.redirect('/admin');
});
